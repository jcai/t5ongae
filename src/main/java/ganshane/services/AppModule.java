...
import ganshane.services.entity.EntityManagerManager;
...
public class AppModule {
	...
	public static EntityManagerManager buildEntityManagerManager(
		...
		EntityManagerManagerImpl service = new EntityManagerManagerImpl(
	...
	public static EntityManager buildEntityManager(EntityManagerManager entityManagerManager,
            PropertyShadowBuilder propertyShadowBuilder){
		return propertyShadowBuilder.build(entityManagerManager, "entityManager", EntityManager.class);
	}
